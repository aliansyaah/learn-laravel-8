                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{--
                                        jika ada old value, tampilkan old value
                                        jika tidak ada, tampilkan data inventory kode (dari DB) 
                                    --}}
                                    <input type="text" name="inventory_kode" 
                                    @if (old('inventory_kode'))
                                        value="{{ old('inventory_kode') }}"
                                    @else
                                        value="{{ $data_barang->inventory_kode }}"
                                    @endif
                                    class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if (old('inventory_name'))
                                        value="{{ old('inventory_name') }}"
                                    @else
                                        value="{{ $data_barang->inventory_name }}"
                                    @endif
                                    class="form-control">
                                </div>
                            </div>
